...
const shell = require('shelljs'); // Make this a variable to permit mocking during testing
...
module.exports = function validateBranch(branch) {
  ...
  const currentBranch = shell.exec('git rev-parse --abbrev-ref HEAD').stdout.split('\n')[0];
