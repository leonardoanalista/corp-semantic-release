...
Welcome! This document explains how you can contribute to making **corp-semantic-release** even better.
...
corp-semantic-release/
 ...
 │
 ├──spec/                         * unit test specifications live here
 │
 ├──confit.yml                    * the project config file generated by 'yo confit'
 ├──.nycrc                        * unit test coverage, reporting and threshold config
